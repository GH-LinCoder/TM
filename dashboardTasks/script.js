...
/*  new authors 21.23 18 Oct 2024  */
let authoSummary=document.querySelector("#authorSummary");
document.getElementById("authorSummary").value="Authors ["+summaryData[0].countAuthors+"]  change [0]";
...
function showTasklist(){//display students
  prism.style.transform = "translateZ(-100px)";
  //need fetch data: 
}

function showTasks(){//display managers
  prism.style.transform = "translateZ(-100px) rotateY( 90deg)";
  //need fetch data: 
}

function showStages(){//display user details
  prism.style.transform = "translateZ(-100px) rotateY( 180deg)"; 
  //need fetch data: 
}


function showOTHER(){//display tasks
  prism.style.transform = "translateZ(-100px) rotateY( -90deg)";
  //need fetch data: 
}
