...
<head><meta charset="UTF-8">
 ...
 $TaskId=4; //Where should this value be assigned??
 echo "<br>PHP ....ByTask()<br>";

$TaskId=$_POST['taskId']; //doesn't have any value. Why?
echo "PHP TaskId: ".$TaskId."<br>";
//13------------------------------------
