...
while(cookie=(getCookie("Task"+TaskId+"Stages"+i)))//have to guess the stage numbers?
     ...
     // document.getElementById("panel").innerHTML+= getCookie("StagesForTask"+TaskId);


//var indexStart=cookie.indexOf("{");
//var indexEnd=cookie.indexOf("}");
//document.getElementById("panel").innerHTML+= "Index of:"+indexStart+" to "+indexEnd+"<br>";//this works because it is a string




//var cookie=(getCookie("StagesForTask"+TaskId));


//document.getElementById("panel").innerHTML+= "cookie2 "+cookie2[0].TSId +cookie2[0].TaskId+cookie2[0].StageName+cookie2[0].StageNum+cookie2[0].StageDesc;// this is the 5th char "S" cookie is a string   it can't be treated as an array of objects  undefined


//document.getElementById("panel").innerHTML+="<br>>>"+ cookie[1].TSId ;//not good


      //document.getElementById("stageDesc").innerHTML= getCookie("TaskDesc");
    //  document.getElementById("stageNumber").innerHTML= getCookie(""); 
